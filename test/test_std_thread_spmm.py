...
def test_std_thread_sparse_mm(handler, dim1, dim2, density, num_threads):
    ...
    result_sparse: torch.Tensor = handler.std_thread_sparse_mm(sparse_matrix1, sparse_matrix2, test_configuration, num_threads=num_threads)
...
#     # Multiply the sparse matrices using your function
#     result_sparse: torch.Tensor = handler.std_thread_sparse_mm(sparse_matrix1, sparse_matrix2, test_configuration, num_threads=num_thread)
#     result_sparse_true: torch.Tensor = torch.sparse.mm(sparse_matrix1, sparse_matrix2)
