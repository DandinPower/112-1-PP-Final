    ...
    const torch::Tensor &mat2)
{
    ...
    // omp_view<int64_t>(M + 1, output_indptr.data_ptr<int64_t>());
    // omp_view<int64_t>(nnz, output_col_indices.data_ptr<int64_t>());
    // omp_view<scalar_t>(nnz, output_values.data_ptr<scalar_t>());
    // std::cout << std::endl;
    ...
    // omp_view<int64_t>(nnz, output_row_indices.data_ptr<int64_t>());
    // omp_view<int64_t>(nnz, output_col_indices.data_ptr<int64_t>());
