...
# Keep on the issue of intel performance core and efficiency core will have different performance
...
def test_omp_sparse_mm(handler, dim1, dim2, density, num_threads):
    ...
    result_sparse: torch.Tensor = handler.openmp_mem_effi_sparse_mm(sparse_matrix1, sparse_matrix2, test_configuration, num_threads=num_threads)
