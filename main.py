...
def benchmark_example():
    ...
    config_list = generate_benchmark_configurations(size_start=500, size_end=1000, size_step= 100, density_start=1, density_end=10, density_step=4, num_threads_start=1, num_threads_end=8, num_threads_step=2)
